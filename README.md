...
- recapp-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- recapp-ui: main application module, development time
- recapp-production: module that produces a production mode WAR for deployment
